...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PA3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = CS_PC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CS_PC_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    */
    GPIO_InitStruct.Pin = CS_BP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CS_BP_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(CS_PC_GPIO_Port, CS_PC_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PF1-OSC_OUT     ------> ADC2_IN10
    */
    HAL_GPIO_DeInit(CS_BP_GPIO_Port, CS_BP_Pin);
